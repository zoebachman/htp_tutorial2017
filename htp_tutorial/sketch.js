var weatherData;
//var boop = 0;
var dimYellow = (255, 255, 204);
var brightYellow = (255, 255, 0);
...
function weatherAsk() {
  ...
  //loadJSON(unixTime, gotTimeData)//, 'jsonp');
}
...
function gotData(data) {
  ...
  fill("white");
  text(weatherData.name, 10, 20)
  text(weatherData.weather[0].main, 10, 40)
  text(weatherData.weather[0].description, 10, 50)

  //temp will be rays
  //console.log(weatherData.main.temp);
  var temp = weatherData.main.temp; //yellow color
  fill(255, 255, temp);
  //ellipse(100, 100, temp*100, temp*100 )

  //first, map sunlight values
  //var density = map(amount of sunlight, 0, width, 20, 50)
